...
// grpc::Status LeathServerImpl::bulk_reconstruct_parallel(grpc::ServerContext* context, const leath::ReconstructRangeMessage* request, grpc::ServerWriter<leath::ReconstructReply>* writer) {
